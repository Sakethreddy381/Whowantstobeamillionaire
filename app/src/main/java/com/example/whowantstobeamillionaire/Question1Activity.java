...
public class Question1Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:1 In which year did the United States declare its independence?");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question1Activity.this, "Correct answer! You Earned $100", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(Question1Activity.this, YouLostActivity.class);
