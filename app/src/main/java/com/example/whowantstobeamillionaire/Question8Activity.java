...
public class Question8Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:8 Which of these countries does not have a coastline on the Mediterranean Sea?");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question8Activity.this, "Correct answer!You Earned $100,000", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Question8Activity.this, "Incorrect answer!", Toast.LENGTH_SHORT).show();
                // Move to YouLostActivity or handle loss
                Intent intent = new Intent(Question8Activity.this, YouLostActivity.class);
                startActivity(intent);
            }
        } else {
