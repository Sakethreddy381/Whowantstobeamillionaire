...
public class Question4Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:4 What is the longest river in South America?");

        options.add("Amazon");
        options.add("Nile");
        options.add("Mississippi");
        options.add("Congo");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question4Activity.this, "Correct answer! You Earned $1,000", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(Question4Activity.this, YouLostActivity.class);
                startActivity(intent);
            }
        } else {
