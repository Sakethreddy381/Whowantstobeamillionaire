...
public class Question6Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:6 Who was the first woman to win a Nobel Prize?");

        options.add("Marie Curie");
        options.add("Mother Teresa");
        options.add("Rosa Parks");
        options.add("Margaret Thatcher");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question6Activity.this, "Correct answer!You Earned $10,000", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Question6Activity.this, "Incorrect answer!", Toast.LENGTH_SHORT).show();
                // Move to YouLostActivity or handle loss
                Intent intent = new Intent(Question6Activity.this, YouLostActivity.class);
                startActivity(intent);
            }
        } else {
