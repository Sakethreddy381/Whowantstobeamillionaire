...
public class Question5Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:5 Who is the author of \"The Catcher in the Rye\"?");

        options.add("J.D. Salinger");
        options.add("Harper Lee");
        options.add("John Steinbeck");
        options.add("George Orwell");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question5Activity.this, "Correct answer! You Earned $5,000", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(Question5Activity.this, YouLostActivity.class);
                startActivity(intent);
            }
        } else {
