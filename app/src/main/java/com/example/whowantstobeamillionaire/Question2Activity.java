...
public class Question2Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:2 Who wrote the novel \"The Great Gatsby\"?");

        options.add("Ernest Hemingway");
        options.add("F. Scott Fitzgerald");
        options.add("Mark Twain");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question2Activity.this, "Correct answer! You Earned $250", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(Question2Activity.this, YouLostActivity.class);
                startActivity(intent);
            }
        } else {
