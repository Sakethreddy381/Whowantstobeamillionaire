...
public class Question7Activity extends AppCompatActivity {
    ...
    private void setUpQuestion() {
        ...
        questionTextView.setText("Q:7 In Greek mythology, who is the god of the sea?");

        options.add("Zeus");
        options.add("Poseidon");
        options.add("Apollo");
        options.add("Hades");
    ...
    private void confirmAnswer() {
        ...
        if (selectedRadioButtonId != -1) {
            ...
            if (selectedOption.equals(correctAnswer)) {
                ...
                Toast.makeText(Question7Activity.this, "Correct answer! You Earned $50,000", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Question7Activity.this, "Incorrect answer!", Toast.LENGTH_SHORT).show();
                // Move to YouLostActivity or handle loss
                Intent intent = new Intent(Question7Activity.this, YouLostActivity.class);
                startActivity(intent);
            }
        } else {
